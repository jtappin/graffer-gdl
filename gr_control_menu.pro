    ...
    'Help.About...': if (track_flag) then $
      graff_msg, pdefs.ids.hlptxt, 'Show a quick description of the ' + $
        ...
        msg = ['GRAFFER Version '+string(pdefs.version, format = $
                                         "(I0,'.',I2.2)"), $
               'Copyright: James Tappin 1995-2012']
...
ctlmenu = [{cw_pdmenu_sa, flags:1, name:'File', accel:''}, $
           {cw_pdmenu_sa, 0, 'Save', 'Ctrl+S'}, $
           {cw_pdmenu_sa, 1, 'Save as', ''}, $
           {cw_pdmenu_sa, 0, 'Save binary as ...', 'Ctrl+Shift+S'}, $
           {cw_pdmenu_sa, 2, 'Save ascii as ...', 'Ctrl+Alt+S'}, $
           {cw_pdmenu_sa, 1, 'Dump screen', ''}, $
           {cw_pdmenu_sa, 0, 'PNG', 'Ctrl+Alt+P'}, $
           {cw_pdmenu_sa, 0, 'Tiff', 'Ctrl+Alt+T'}, $
           {cw_pdmenu_sa, 0, 'Nrif', 'Ctrl+Alt+N'}, $
           {cw_pdmenu_sa, 2, 'Choose ...', ''}, $
           {cw_pdmenu_sa, 0, 'Open ...', 'Ctrl+O'}, $
           {cw_pdmenu_sa, 0, 'New ...', 'Ctrl+N'}, $
           {cw_pdmenu_sa, 2, 'Exit', 'Ctrl+Q'}, $
           {cw_pdmenu_sa, 1, 'Hard Copy', ''}, $
           {cw_pdmenu_sa, 0, 'Quick', 'Ctrl+P'}, $
           {cw_pdmenu_sa, 2, 'Set up ...', 'Ctrl+Shift+P'}, $
           {cw_pdmenu_sa, 0, 'Options...', ''}, $
           {cw_pdmenu_sa, 3, 'Help', ''}, $
           {cw_pdmenu_sa, 0, 'User Guide...', 'Ctrl+H'}, $
           {cw_pdmenu_sa, 0, 'File Format...', ''}, $
           {cw_pdmenu_sa, 2, 'About...', ''}]
