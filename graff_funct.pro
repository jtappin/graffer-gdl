...
uvs.minid = graff_enter(rgb, /double, xsize = 12, uvalue = $
                        'MIN', value = range(0), format = "(g12.5)", $
                        label = ax+' axis range: Min:', /capture)
uvs.maxid = graff_enter(rgb, /double, xsize = 12, uvalue = $
                        'MAX', value = range(1), format = "(g12.5)",  $
                        label = ' Max:', /capture)
